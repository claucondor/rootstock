...
// node_modules/solc-version/src/processList.js
var require_processList = __commonJS({
  "node_modules/solc-version/src/processList.js"(exports, module) {
      ...
      const lists = Object.values(data.builds).reduce(({ agg, d }, x, i, arr) => {
        ...
        if (prerelease) {
          ...
          if (ahead !== d) {
            ...
            var diffDays = parseInt((d2 - d1) / (1e3 * 60 * 60 * 24));
            var d3 = new Date(d1);
...
// node_modules/kv-idb/index.js
var require_kv_idb = __commonJS({
  "node_modules/kv-idb/index.js"(exports, module) {
    ...
    function kvidb(opts) {
      ...
      const makeDB = (done) => {
        ...
        idb.onerror = (e) => console2.error(`[${dbname}]`, idb.error);
        idb.onupgradeneeded = () => idb.result.createObjectStore(
          scope
          /*, dbopts*/
        );
      ...
      const use = (mode, done) => {
        const next = (IDB2, tx) => (tx = IDB2.transaction([scope], mode), done(tx.objectStore(scope), tx));
      ...
      const api = {
        get: (key, done) => use("readonly", (store, tx) => {
          ...
          const next = (e, x) => {
            e ? done(e) : x === void 0 ? done(`key "${key}" is undefined`) : done(null, x);
          };
        }),
        put: (key, val, done) => val === void 0 ? done("`value` is undefined") : use("readwrite", (store, tx) => {
        ...
        del: (key, done) => api.get("" + key, (e, x) => {
          e ? done(e) : use("readwrite", (store, tx) => {
            ...
            tx.oncomplete = (e2) => done(req.error, !req.error);
          });
        }),
        ...
        close: (done) => (IDB ? IDB.close() : makeDB((IDB2) => IDB2.close()), done(null, true)),
        ...
        keys: (done) => use("readonly", (store, tx, keys = []) => {
          ...
          tx.oncomplete = (e) => done(req.error, req.error ? void 0 : keys);
          req.onsuccess = () => {
            const x = req.result;
            if (x)
              keys.push(x.key), x.continue();
          };
        })
...
// node_modules/ajax-caching/src/ajaxCache.js
var require_ajaxCache = __commonJS({
  "node_modules/ajax-caching/src/ajaxCache.js"(exports, module) {
    var kvidb = require_kv_idb();
    var cache = kvidb("store-solcjs");
    ...
    function ajaxcache(opts, done) {
      ...
      if (!url)
        done(new Error("`url` or `{ url }` must be a string"));
      ...
      if (window.localStorage[url] && caching) {
        fetch(url, { method: "HEAD" }).then((response) => {
          ...
          if (getCacheTime(url) > lastModified)
            caching = true;
          cacheFetch({ cache, url, caching, transform, lastModified }, done);
        }).catch((e) => {
          console.error("[error]", e);
          cacheFetch({ cache, url, caching: true, transform, lastModified: void 0 }, done);
        });
    ...
    function getLastModified(response) {
      ...
      lastModified = Date.parse(lastModified) / 1e3;
      return lastModified;
    }
    function cacheFetch({ cache: cache2, url, caching, transform, lastModified }, done) {
      const fromCache = isLatest(caching, url, lastModified);
      if (fromCache)
        return cache2.get(url, done);
    ...
    function setCache(url, data, caching) {
      cache.put(url, data, (error) => {
        ...
        waitingQueue[url] = void 0;
        if (error)
          return listener.forEach((fn) => fn(error));
    ...
    function setCacheTime(caching, url) {
      if (caching) {
        ...
        let timestamp = Math.floor(dateTime / 1e3);
...
// node_modules/ajax-caching/src/promiseAjax.js
var require_promiseAjax = __commonJS({
  "node_modules/ajax-caching/src/promiseAjax.js"(exports, module) {
    var cacheAjax = require_ajaxCache();
...
// node_modules/ajax-caching/src/index.js
var require_src = __commonJS({
  "node_modules/ajax-caching/src/index.js"(exports, module) {
    module.exports = {
      promiseAjax: require_promiseAjax()
    };
  }
});

// node_modules/solc-version/src/getlist.js
var require_getlist = __commonJS({
  "node_modules/solc-version/src/getlist.js"(exports, module) {
    var baseURL = "https://solc-bin.ethereum.org/bin";
    var ajaxCaching = require_src();
    var promiseAjax = ajaxCaching.promiseAjax;
...
// node_modules/solc-version/src/version2url.js
var require_version2url = __commonJS({
  "node_modules/solc-version/src/version2url.js"(exports, module) {
    var baseURL = "https://solc-bin.ethereum.org/bin";
    var processList = require_processList();
    var getlist = require_getlist();
    ...
    function version2url(version, list) {
      return new Promise(async (resolve, reject) => {
        try {
          ...
          if (version === "nightly")
            version = Object.keys(all)[0];
          var path = all[version];
          if (!path)
            return reject(new Error(`unknown version: ${version}`));
...
// node_modules/solc-version/src/groupByVersion.js
var require_groupByVersion = __commonJS({
  "node_modules/solc-version/src/groupByVersion.js"(exports, module) {
...
// node_modules/solc-version/src/versions.js
var require_versions = __commonJS({
  "node_modules/solc-version/src/versions.js"(exports, module) {
    var processList = require_processList();
    var getlist = require_getlist();
    var groupByVersion = require_groupByVersion();
...
// node_modules/solc-version/src/versionsSkipVersion5.js
var require_versionsSkipVersion5 = __commonJS({
  "node_modules/solc-version/src/versionsSkipVersion5.js"(exports, module) {
    var processList = require_processList();
    var getlist = require_getlist();
    var groupByVersion = require_groupByVersion();
...
// node_modules/solc-version/src/index.js
var require_src2 = __commonJS({
  "node_modules/solc-version/src/index.js"(exports, module) {
    module.exports = {
      version2url: require_version2url(),
      versions: require_versions(),
      versionsSkipVersion5: require_versionsSkipVersion5()
    };
  }
});

// node_modules/solc-import/src/getImports.js
var require_getImports = __commonJS({
  "node_modules/solc-import/src/getImports.js"(exports, module) {
...
// node_modules/solc-import/src/isExistImport.js
var require_isExistImport = __commonJS({
  "node_modules/solc-import/src/isExistImport.js"(exports, module) {
    var getImports = require_getImports();
...
// node_modules/solc-import/src/combineSource.js
var require_combineSource = __commonJS({
  "node_modules/solc-import/src/combineSource.js"(exports, module) {
    var getImports = require_getImports();
    var isExistImport = require_isExistImport();
    ...
    async function combineSource(source, getImportContent) {
      try {
        ...
        let sourceMap = /* @__PURE__ */ new Map();
...
// node_modules/solc-import/src/getReadCallback.js
var require_getReadCallback = __commonJS({
  "node_modules/solc-import/src/getReadCallback.js"(exports, module) {
    var combineSource = require_combineSource();
...
// node_modules/solc-import/src/replaceContent.js
var require_replaceContent = __commonJS({
  "node_modules/solc-import/src/replaceContent.js"(exports, module) {
    var getImports = require_getImports();
    var isExistImport = require_isExistImport();
...
// node_modules/solc-import/src/index.js
var require_src3 = __commonJS({
  "node_modules/solc-import/src/index.js"(exports, module) {
    module.exports = {
      combineSource: require_combineSource(),
      getImports: require_getImports(),
      getReadCallback: require_getReadCallback(),
      isExistImport: require_isExistImport(),
      replaceContent: require_replaceContent()
    };
  }
});

// node_modules/solc-resolver/src/resolverEngine.js
var require_resolverEngine = __commonJS({
  "node_modules/solc-resolver/src/resolverEngine.js"(exports, module) {
...
// node_modules/solc-resolver/src/index.js
var require_src4 = __commonJS({
  "node_modules/solc-resolver/src/index.js"(exports, module) {
    module.exports = {
      resolverEngine: require_resolverEngine()
    };
  }
});

// node_modules/solcjs-core/node_modules/ajax-caching/src/ajaxCache.js
var require_ajaxCache2 = __commonJS({
  "node_modules/solcjs-core/node_modules/ajax-caching/src/ajaxCache.js"(exports, module) {
    var kvidb = require_kv_idb();
    var cache = kvidb("store-solcjs");
    module.exports = ajaxcache;
    ajaxcache.clear = () => cache.clear();
    ...
    function ajaxcache(opts, done) {
      ...
      if (window && window.localStorage[url] && caching) {
        fetch(url, { method: "HEAD" }).then((response) => {
          ...
          console.error("[error]", e);
          cacheFetch(
            { cache, url, caching: true, transform, lastModified: void 0 },
            done
          );
        });
      } else if (waitingQueue[url]) {
...
// node_modules/solcjs-core/node_modules/ajax-caching/src/promiseAjax.js
var require_promiseAjax2 = __commonJS({
  "node_modules/solcjs-core/node_modules/ajax-caching/src/promiseAjax.js"(exports, module) {
    var cacheAjax = require_ajaxCache2();
    module.exports = promiseAjax;
    function promiseAjax(opts) {
      return new Promise(function(resolve, reject) {
        try {
...
// node_modules/solcjs-core/node_modules/ajax-caching/src/index.js
var require_src5 = __commonJS({
  "node_modules/solcjs-core/node_modules/ajax-caching/src/index.js"(exports, module) {
    module.exports = {
      promiseAjax: require_promiseAjax2()
    };
  }
});

// node_modules/solcjs-core/src/getCompilersource.js
var require_getCompilersource = __commonJS({
  "node_modules/solcjs-core/src/getCompilersource.js"(exports, module) {
    var ajaxCaching = require_src5();
    var promiseAjax = ajaxCaching.promiseAjax;
...
// node_modules/solcjs-core/src/getReadCallback.js
var require_getReadCallback2 = __commonJS({
  "node_modules/solcjs-core/src/getReadCallback.js"(exports, module) {
    var solcImport = require_src3();
    module.exports = getReadCallback;
    async function getReadCallback(sourcecode, getImportContent) {
...
// node_modules/solcjs-core/node_modules/solc-version/src/processList.js
var require_processList2 = __commonJS({
  "node_modules/solcjs-core/node_modules/solc-version/src/processList.js"(exports, module) {
    module.exports = processList;
    function processList(json) {
      const data = JSON.parse(json);
      const lists = Object.values(data.builds).reduce(({ agg, d }, x, i, arr) => {
...
// node_modules/solcjs-core/node_modules/solc-version/src/getlist.js
var require_getlist2 = __commonJS({
  "node_modules/solcjs-core/node_modules/solc-version/src/getlist.js"(exports, module) {
    var baseURL = "https://solc-bin.ethereum.org/bin";
    var ajaxCaching = require_src5();
    var promiseAjax = ajaxCaching.promiseAjax;
    module.exports = getlist;
...
// node_modules/solcjs-core/node_modules/solc-version/src/version2url.js
var require_version2url2 = __commonJS({
  "node_modules/solcjs-core/node_modules/solc-version/src/version2url.js"(exports, module) {
    var baseURL = "https://solc-bin.ethereum.org/bin";
    var processList = require_processList2();
    var getlist = require_getlist2();
    ...
    function version2url(version, list) {
      return new Promise(async (resolve, reject) => {
        try {
          ...
          const { all, releases } = select;
          if (version === "stable")
            version = _.keys(releases).reverse()[0];
...
// node_modules/solcjs-core/node_modules/solc-version/src/groupByVersion.js
var require_groupByVersion2 = __commonJS({
  "node_modules/solcjs-core/node_modules/solc-version/src/groupByVersion.js"(exports, module) {
    module.exports = groupByVersion;
    function removeAllZeroPointFiveVersion(select) {
      select.nightly = select.nightly.filter((x) => !~x.indexOf("v0.5."));
      select.all = select.all.filter((x) => !~x.indexOf("v0.5."));
...
// node_modules/solcjs-core/node_modules/solc-version/src/versions.js
var require_versions2 = __commonJS({
  "node_modules/solcjs-core/node_modules/solc-version/src/versions.js"(exports, module) {
    var processList = require_processList2();
    var getlist = require_getlist2();
    var groupByVersion = require_groupByVersion2();
    module.exports = versions;
    function versions(list) {
      return new Promise(async (resolve, reject) => {
        try {
...
// node_modules/solcjs-core/node_modules/solc-version/src/versionsSkipVersion5.js
var require_versionsSkipVersion52 = __commonJS({
  "node_modules/solcjs-core/node_modules/solc-version/src/versionsSkipVersion5.js"(exports, module) {
    var processList = require_processList2();
    var getlist = require_getlist2();
    var groupByVersion = require_groupByVersion2();
    module.exports = versionsSkipVersion5;
...
// node_modules/solcjs-core/node_modules/solc-version/src/index.js
var require_src6 = __commonJS({
  "node_modules/solcjs-core/node_modules/solc-version/src/index.js"(exports, module) {
    module.exports = {
      version2url: require_version2url2(),
      versions: require_versions2(),
      versionsSkipVersion5: require_versionsSkipVersion52()
    };
  }
});

// node_modules/solcjs-core/src/getVersion.js
var require_getVersion = __commonJS({
  "node_modules/solcjs-core/src/getVersion.js"(exports, module) {
    var solcVersion = require_src6();
    module.exports = getVersion;
    async function getVersion(_version) {
      if (typeof _version == "string" && _version.length < 30)
        return _version;
      let select;
      if (_version == void 0) {
...
// node_modules/solcjs-core/src/loadModule.js
var require_loadModule = __commonJS({
  "node_modules/solcjs-core/src/loadModule.js"(exports, module) {
...
// node_modules/solcjs-core/src/pretest.js
var require_pretest = __commonJS({
  "node_modules/solcjs-core/src/pretest.js"(exports, module) {
...
// node_modules/solcjs-core/src/solc-wrapper/translate/standardTranslateJsonCompilerOutput.js
var require_standardTranslateJsonCompilerOutput = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/translate/standardTranslateJsonCompilerOutput.js"(exports, module) {
    module.exports = standardTranslateJsonCompilerOutput;
    function standardTranslateJsonCompilerOutput({ version, url }, data) {
      if (isMatchVersion(version, "0.1"))
        throw Error("don't support v0.1.x version.");
      try {
    ...
    function getAssembly(contract, name, version) {
      if (isNewVersion(version)) {
        let name2 = Object.keys(contract)[0];
        return contract[name2].evm.legacyAssembly;
      } else {
    ...
    function getGasEstimates(contract, name, version) {
      if (isNewVersion(version)) {
        let name2 = Object.keys(contract)[0];
        return contract[name2].evm.gasEstimates;
      } else {
    ...
    function getDevDoc(contract, metadata, version) {
      if (isMatchVersion(version, "0.5")) {
        ...
        if (!metadata.output)
          return;
        if (JSON.stringify(metadata.output.devdoc.methods) == "{}")
          return;
...
// node_modules/solcjs-core/src/getCompileOutput.js
var require_getCompileOutput = __commonJS({
  "node_modules/solcjs-core/src/getCompileOutput.js"(exports, module) {
    var solcImport = require_src3();
...
// node_modules/solcjs-core/src/getStandardError.js
var require_getStandardError = __commonJS({
  "node_modules/solcjs-core/src/getStandardError.js"(exports, module) {
...
// node_modules/solcjs-core/src/wrapperCompile.js
var require_wrapperCompile = __commonJS({
  "node_modules/solcjs-core/src/wrapperCompile.js"(exports, module) {
    var translateJsonCompilerOutput = require_standardTranslateJsonCompilerOutput();
    var getCompileOutput = require_getCompileOutput();
    var getStandardError = require_getStandardError();
...
// node_modules/solcjs-core/src/getCompile.js
var require_getCompile = __commonJS({
  "node_modules/solcjs-core/src/getCompile.js"(exports, module) {
    var solcImport = require_src3();
    var getReadCallback = require_getReadCallback2();
    var wrapperCompile = require_wrapperCompile();
    ...
    function getCompile(oldSolc) {
      ...
      Object.keys(oldSolc).forEach((key) => {
        ...
        compile = async function(sourcecode = "", getImportContent) {
          if (solcImport.isExistImport(sourcecode)) {
            if (getImportContent == void 0)
              throw Error("you should pass getImportContent function in the second pararmeter.");
          }
...
// node_modules/solcjs-core/src/solc-wrapper/linker.js
var require_linker = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/linker.js"(exports, module) {
...
// node_modules/solcjs-core/src/solc-wrapper/translate/prettyPrintLegacyAssemblyJSON.js
var require_prettyPrintLegacyAssemblyJSON = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/translate/prettyPrintLegacyAssemblyJSON.js"(exports, module) {
    ...
    function formatAssemblyText(asm, prefix, source) {
      if (typeof asm === "string" || asm === null || asm === void 0) {
        return prefix + (asm || "") + "\n";
      }
      var text = prefix + ".code\n";
      asm[".code"].forEach(function(item2, i2) {
        var v = item2.value === void 0 ? "" : item2.value;
        var src = "";
        if (source !== void 0 && item2.begin !== void 0 && item2.end !== void 0) {
          src = escapeString(source.slice(item2.begin, item2.end));
        }
        if (src.length > 30) {
          src = src.slice(0, 30) + "...";
        }
...
// node_modules/solcjs-core/src/solc-wrapper/translate/versionToSemver.js
var require_versionToSemver = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/translate/versionToSemver.js"(exports, module) {
...
// node_modules/solcjs-core/src/solc-wrapper/translate/index.js
var require_translate = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/translate/index.js"(exports, module) {
    module.exports = {
      standardTranslateJsonCompilerOutput: require_standardTranslateJsonCompilerOutput(),
      prettyPrintLegacyAssemblyJSON: require_prettyPrintLegacyAssemblyJSON(),
      versionToSemver: require_versionToSemver()
    };
  }
});

// node_modules/solcjs-core/src/solc-wrapper/wrapper.js
var require_wrapper = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/wrapper.js"(exports, module) {
    var linker = require_linker();
...
// node_modules/solcjs-core/src/solc.js
var require_solc = __commonJS({
  "node_modules/solcjs-core/src/solc.js"(exports, module) {
    var solcVersion = require_src6();
    var getCompile = require_getCompile();
    var getVersion = require_getVersion();
    var getCompilersource = require_getCompilersource();
    var loadModule = require_loadModule();
    var pretest = require_pretest();
    var solcWrapper = require_wrapper();
...
// node_modules/solcjs-core/src/solc-wrapper/abi.js
var require_abi = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/abi.js"(exports, module) {
...
// node_modules/solcjs-core/src/solc-wrapper/index.js
var require_solc_wrapper = __commonJS({
  "node_modules/solcjs-core/src/solc-wrapper/index.js"(exports, module) {
    module.exports = {
      linker: require_linker(),
...
// node_modules/solcjs-core/src/index.js
var require_src7 = __commonJS({
  "node_modules/solcjs-core/src/index.js"(exports, module) {
    module.exports = {
      getCompilersource: require_getCompilersource(),
      getReadCallback: require_getReadCallback2(),
      getVersion: require_getVersion(),
      loadModule: require_loadModule(),
      pretest: require_pretest(),
      wrapperCompile: require_wrapperCompile(),
      getCompile: require_getCompile(),
      solc: require_solc(),
      solcWrapper: require_solc_wrapper()
    };
  }
});

// node_modules/resolve-github/src/resolver.js
var require_resolver = __commonJS({
  "node_modules/resolve-github/src/resolver.js"(exports, module) {
...
// node_modules/resolve-github/src/parser.js
var require_parser = __commonJS({
  "node_modules/resolve-github/src/parser.js"(exports, module) {
    var replaceContent = require_src3().replaceContent;
    var resolver = require_resolver();
    module.exports = async function(importPath) {
      const [, , , root, path] = require_src8().match.exec(importPath);
    ...
    async function getData(url) {
      ...
      if (!response.ok || response.status !== 200)
        throw Error("Content " + data);
      return data;
    }
    function isSymbolicLink(data) {
      if (data.length < 50 && data.indexOf(".sol"))
        return true;
      return false;
    }
  }
...
// node_modules/resolve-github/src/index.js
var require_src8 = __commonJS({
  "node_modules/resolve-github/src/index.js"(exports, module) {
    module.exports = {
      type: "github",
...
// node_modules/resolve-http/src/resolver.js
var require_resolver2 = __commonJS({
  "node_modules/resolve-http/src/resolver.js"(exports, module) {
    module.exports = function(content, from, subImportPath) {
      let newContent = content;
      let url = new window.URL(subImportPath, from);
      let fixedPath = url.href;
...
// node_modules/resolve-http/src/parser.js
var require_parser2 = __commonJS({
  "node_modules/resolve-http/src/parser.js"(exports, module) {
    var replaceContent = require_src3().replaceContent;
    var resolver = require_resolver2();
    module.exports = async function(importPath) {
      const [, url] = require_src9().match.exec(importPath);
      try {
...
// node_modules/resolve-http/src/index.js
var require_src9 = __commonJS({
  "node_modules/resolve-http/src/index.js"(exports, module) {
    module.exports = {
      type: "http",
      parser: require_parser2(),
      resolver: require_resolver2(),
      match: /^(http|https?:\/\/?(.*))$/
    };
  }
});

// node_modules/resolve-ipfs/src/parser.js
var require_parser3 = __commonJS({
  "node_modules/resolve-ipfs/src/parser.js"(exports, module) {
    module.exports = async function(importPath) {
      let [, url] = require_src10().match.exec(importPath);
...
// node_modules/resolve-ipfs/src/resolver.js
var require_resolver3 = __commonJS({
  "node_modules/resolve-ipfs/src/resolver.js"(exports, module) {
    module.exports = function(content, from, subImportPath) {
      let newContent = content;
      let url = new window.URL(subImportPath, from);
      let fixedPath = url.href;
...
// node_modules/resolve-ipfs/src/index.js
var require_src10 = __commonJS({
  "node_modules/resolve-ipfs/src/index.js"(exports, module) {
    module.exports = {
      type: "ipfs",
      parser: require_parser3(),
      resolver: require_resolver3(),
      match: /^(ipfs:\/\/?.+)/
    };
  }
});

// node_modules/resolve-swarm/src/parser.js
var require_parser4 = __commonJS({
  "node_modules/resolve-swarm/src/parser.js"(exports, module) {
    module.exports = async function(importPath) {
      const [, url] = require_src11().match.exec(importPath);
      try {
...
// node_modules/resolve-swarm/src/resolver.js
var require_resolver4 = __commonJS({
  "node_modules/resolve-swarm/src/resolver.js"(exports, module) {
    module.exports = function(content, from, subImportPath) {
      let newContent = content;
      let url = new window.URL(subImportPath, from);
      let fixedPath = url.href;
...
// node_modules/resolve-swarm/src/index.js
var require_src11 = __commonJS({
  "node_modules/resolve-swarm/src/index.js"(exports, module) {
    module.exports = {
      type: "swarm",
      parser: require_parser4(),
      resolver: require_resolver4(),
      match: /^(bzz[ri]?:\/\/?(.*))$/
    };
  }
});

// node_modules/solc-js/src/getCompile.js
var require_getCompile2 = __commonJS({
  "node_modules/solc-js/src/getCompile.js"(exports, module) {
    var solcImport = require_src3();
    var solcResolver = require_src4();
    var solcjsCore = require_src7();
    module.exports = getCompile;
    function getCompile(oldSolc) {
      let compile;
      Object.keys(oldSolc).forEach((key) => {
    ...
    function getContent() {
      const ResolverEngine = require_src4().resolverEngine;
      let resolverEngine = new ResolverEngine();
      let resolveGithub = require_src8();
      resolverEngine.addResolver(resolveGithub);
      let resolveHttp = require_src9();
      resolverEngine.addResolver(resolveHttp);
      let resolveIPFS = require_src10();
      resolverEngine.addResolver(resolveIPFS);
      let resolveSwarm = require_src11();
...
// node_modules/solc-js/src/solc.js
var require_solc2 = __commonJS({
  "node_modules/solc-js/src/solc.js"(exports, module) {
    var solcVersion = require_src2();
    var getCompile = require_getCompile2();
    var solcjsCore = require_src7();
    var solcWrapper = solcjsCore.solcWrapper.wrapper;
    function solcjs(_version) {
      return new Promise(async (resolve, reject) => {
        let newCompile;
        let version;
...
// node_modules/solc-js/src/index.js
var require_src12 = __commonJS({
  "node_modules/solc-js/src/index.js"(exports, module) {
    var solcjs = require_solc2();
    var solcVersion = require_src2();
    module.exports = solcjs;
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=solc-js.js.map
