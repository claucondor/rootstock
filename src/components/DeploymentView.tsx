...
const DeploymentView = ({ contract, onDeploymentSuccess }: DeploymentViewProps) => {
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      setDeploymentError('Error al desplegar el contrato. Por favor, inténtelo de nuevo.');
      setIsDeploying(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-400">Despliega tu contrato inteligente en la testnet de Rootstock.</p>
      
      <Card className="bg-gray-800 border-gray-700">
        <CardHeader>
          <CardTitle className="text-white">Configuración de Despliegue</CardTitle>
          <CardDescription>
          ...
          {!deployedAddress ? (
            <div className="space-y-4">
              <div className="p-4 bg-gray-900 rounded-md">
                <h4 className="text-sm font-medium text-gray-300 mb-2">Información del Contrato</h4>
                <div className="grid grid-cols-1 gap-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">{Math.floor(contract.bytecode.length / 2)} bytes</span>
                  </div>
                </div>
              </div>
            ...
            >
              <Alert className="bg-green-900/20 border-green-800">
                ...
                <AlertTitle className="text-green-500">Contrato desplegado correctamente</AlertTitle>
              ...
              <div className="p-4 bg-gray-900 rounded-md">
                <h4 className="text-sm font-medium text-gray-300 mb-2">Información del Despliegue</h4>
                <div className="grid grid-cols-1 gap-2 text-sm">
                  ...
                  {deploymentTxHash && (
                    <div className="flex justify-between items-center">
                      <span className="text-gray-400">Hash de Transacción:</span>
                      <motion.span 
              ...
              <div className="flex justify-end">
                <Button 
                  variant="outline" 
                  onClick={() => window.open(`https://explorer.testnet.rsk.co/address/${deployedAddress}`, '_blank')}
