  ...
  const technologies = [
    {
      ...
      description: "Red blockchain compatible con EVM que permite contratos inteligentes en Bitcoin"
    },
    {
      name: "OpenZeppelin",
    ...
    },
    {
      ...
      description: "Lenguaje de programación para contratos inteligentes en Ethereum y redes compatibles"
    },
    {
      name: "Hardhat",
      logo: "https://seeklogo.com/images/H/hardhat-logo-888739EBB4-seeklogo.com.png",
      description: "Entorno de desarrollo para compilar, probar y desplegar contratos inteligentes"
    },
    {
      name: "React",
    ...
    },
    {
      ...
      description: "Superset de JavaScript con tipado estático para desarrollo más robusto"
    }
  ];
    ...
    <section className="py-20 bg-gray-950">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Nuestra plataforma está construida con las tecnologías más avanzadas y seguras del ecosistema blockchain.
          </motion.p>
        </div>
        ...
        >
          <div className="inline-block px-6 py-3 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300">
              Todas estas tecnologías se combinan para ofrecerte la mejor experiencia en la generación de contratos inteligentes.
            </p>
          </div>
        </motion.div>
      </div>
