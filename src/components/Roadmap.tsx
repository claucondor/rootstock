...
const Roadmap = () => {
  ...
  return (
    <div className="relative max-w-6xl mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold text-center text-white mb-12">Nuestro Roadmap</h2>
                  ...
                  {activeSlide === index && (
                    ...
                    >
                      <div className="flex items-center">
                        <div className={`h-3 w-3 rounded-full ${index <= activeSlide ? 'bg-green-500' : 'bg-gray-600'} mr-3`}></div>
                        <span className="text-sm text-gray-400">
                          {index < activeSlide ? 'Completado' : index === activeSlide ? 'En progreso' : 'Pendiente'}
                        </span>
                      </div>
                    </motion.div>
                  )}
